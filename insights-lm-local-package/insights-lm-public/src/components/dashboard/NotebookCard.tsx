    ...
    >
      <div className="absolute top-3 right-3" data-delete-action="true">
        <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              <AlertDialogTitle>Diese Arbeitsmappe löschen?</AlertDialogTitle>
              <AlertDialogDescription>
                Du bist dabei, diese Arbeitsmappe und alle ihre Inhalte zu löschen. Dies kann nicht rückgängig gemacht werden.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
              <AlertDialogCancel>Abbrechen</AlertDialogCancel>
              <AlertDialogAction onClick={handleConfirmDelete} className="bg-[#8f0c41] hover:bg-[#b81a5a]" disabled={isDeleting}>
      ...
      <div className="flex items-center justify-between text-sm text-gray-500 mt-auto">
        <span>{notebook.date} • {notebook.sources} Quelle{notebook.sources !== 1 ? 'n' : ''}</span>
      </div>
    </div>;
};
